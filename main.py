...
def main(date : str, to_email: list, check_keys: bool = True):
    ...
    for code in codeList:
        ...
        download(code=code, result=response, date=date)

        if check_keys:
                
            result = checkForKeys(code=code, date=date)
        ...
        send_email(subject="Actualización del DOF detectada", body=email_body, to_email=to_email, code=code, date=date)
